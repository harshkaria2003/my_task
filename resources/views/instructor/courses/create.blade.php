                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('instructor.courses.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-4 text-center" id="preview-container" style="display: none;">
                            <img id="preview-image" src="#" class="img-fluid img-thumbnail rounded-3 shadow-sm" style="max-height: 250px;">
                        </div>

                      
                        <div class="d-flex flex-column flex-sm-row justify-content-between align-items-stretch gap-3 mt-4">
                            <a href="{{ route('instructor.courses.index') }}"
                               class="btn btn-outline-secondary btn-lg d-flex justify-content-center align-items-center gap-2 w-100 w-sm-auto">
                                <i class="bi bi-arrow-left-circle fs-5"></i> Cancel
                            </a>
                            <button type="submit"
                                    class="btn btn-success btn-lg d-flex justify-content-center align-items-center gap-2 w-100 w-sm-auto">
